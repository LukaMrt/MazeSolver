...
public class MazePath {
    ...
    public MazePath(Maze maze, Point point, List<Point> parents) {
        this.maze = maze;
        this.point = point;
    ...
    private List<Point> append(int index) {
        ...
        if (canGo)
            list1 = new MazePath(this.maze, nextPoint, new ArrayList<>(this.parents)).compute();

        return list1 != null && (list2 == null || list1.size() < list2.size()) ? list1 : list2;
